...
try:
    modelo = joblib.load("modelo_powertrack_v3.pkl")
...
class PerfilUsuario(BaseModel):
    ...
    peso_cat: int = Field(..., ge=0, le=4, description="0=menos60kg, 1=60-75kg, 2=76-90kg, 3=91-110kg, 4=mas110kg")
...
@app.get("/health")
def health():
    return {"status": "ok", "modelo": "modelo_powertrack_v3.pkl"}